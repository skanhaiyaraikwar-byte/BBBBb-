...
def display_banner():
    ...
    banner = f"""
{color}{Colors.BRIGHT}
𝗦. 𝗞𝗔𝗡𝗛𝗔𝗜𝗬𝗔 𝗙𝗙 𝗜𝗗{Colors.RESET}\n{get_random_color()}{Colors.BRIGHT}\n\n{get_random_color()}{Colors.BRIGHT}\n\n{get_random_color()}{Colors.BRIGHT}{Colors.RESET}{Colors.RESET}\n{get_random_color()}{Colors.BRIGHT}\n{Colors.RESET}{get_random_color()}{Colors.BRIGHT}
"""
    print(banner)
    ...
    while True:
        try:
            ...
            if choice == "00":
                ...
                print(f"\n{get_random_color()}{Colors.BRIGHT}👋!{Colors.RESET}")
                sys.exit(0)
            elif choice.isdigit():
...
def about_section():
    ...
    print(f"{get_random_color()}{Colors.BRIGHT}ℹ️ S. KANHAIYA{Colors.RESET}")
...
def main_menu():
    while True:
        ...
        print(f"{get_random_color()}{Colors.BRIGHT}Welcome{Colors.RESET}")
